...
public class AluguelSeletor {
    ...
    public AluguelSeletor(LocalDateTime dataCheckin, LocalDateTime dataCheckoutPrevisto, LocalDateTime dataCheckoutEfetivo, double valorTotal, double valorDiaria, double valorLimpeza, double valorMulta, int qtdDias, int isOcupado, Imovel imovel, Inquilino inquilino) {
